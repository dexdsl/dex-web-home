...
await writeFile(templatePath, `<!doctype html><html><head><title>x</title><script id="dex-sidebar-config" type="application/json">{"downloads":{"formats":{"audio":[{"key":"wav"}],"video":[{"key":"1080p"}]}}</script><script id="dex-manifest" type="application/json">{}</script><!-- DEX:SIDEBAR_PAGE_CONFIG_START --><script>window.dexSidebarPageConfig = {};</script><!-- DEX:SIDEBAR_PAGE_CONFIG_END --></head><body><!-- DEX:VIDEO_START --><div class="sqs-video-wrapper" data-url="" data-html="&lt;iframe src=&quot;https://www.youtube.com/embed/seed&quot;&gt;&lt;/iframe&gt;"></div><!-- DEX:VIDEO_END --><!-- DEX:DESC_START --><p></p><!-- DEX:DESC_END --></body></html>`, 'utf8');
