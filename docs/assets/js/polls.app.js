(()=>{(()=>{if(typeof window=="undefined"||typeof document=="undefined")return;if(window.__dxPollsAppLoaded&&typeof window.__dxPollsQueueBoot=="function"){try{window.__dxPollsQueueBoot()}catch{}return}window.__dxPollsAppLoaded=!0;let E=120,P="dx-polls-app-style",N=12,B=8;function D(){if(document.getElementById(P))return;let t=document.createElement("style");t.id=P,t.textContent=`
    ...
    `,v(t)}function X(t,e,o,a,l="idle"){let n=_(e)||!!o.closed,s=Array.isArray(o.counts)?o.counts:e.options.map((i,r)=>{var c;return Number(((c=o.counts)==null?void 0:c[String(r)])||0)}),d=e.options.map((i,r)=>{let c=Math.max(0,Number(s[r])||0),h=o.total>0?Math.round(c/o.total*100):0;return`
      ...
      `}).join(""),p=e.visibility==="members"?'<span class="dx-poll-chip">Members</span>':'<span class="dx-poll-chip">Public</span>',f=l==="saving"?"Submitting vote\u2026":l==="saved"?"Vote saved":l==="error"?"Vote failed":"";t.innerHTML=`
      <section class="dx-polls-shell">
        <article class="dx-polls-panel dx-poll-detail" data-dx-motion="pagination">
          ...
          <p class="dx-polls-subtitle">${n?`Closed ${b(e.closeAt)}`:`Closes ${b(e.closeAt)} (${C(e.closeAt)})`}</p>
