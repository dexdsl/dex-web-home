(()=>{(()=>{if(typeof window=="undefined"||typeof document=="undefined")return;if(window.__dxPollsAppLoaded&&typeof window.__dxPollsQueueBoot=="function"){try{window.__dxPollsQueueBoot()}catch{}return}window.__dxPollsAppLoaded=!0;let E=120,C="dx-polls-app-style",N=12,B=8;function D(){if(document.getElementById(C))return;let t=document.createElement("style");t.id=C,t.textContent=`
      .dx-polls-shell{
